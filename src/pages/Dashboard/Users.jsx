                ...
                <tbody>
                  {users.map((user, index) => (
                    ...
                    <div className={usersStyles.userInfo}>
                     ...
                     <td>
                          <span
                            className={`${usersStyles.journeyTag} ${
                              user.journey === "Preconception"
                                ? usersStyles.Preconception
                                : user.journey === "Pregnancy"
                                ? usersStyles.Pregnancy
                                : user.journey === "Return to Work"
                                ? usersStyles.ReturntoWork
                                : ""
                            }`}
                          >
                            {user.journey}
